...
const Lab: React.FC = () => {
    ...
    const noteSpace = () => {
            const notes = [
                ...
                {
                    practical2: "INSPECTION\n\nThis experiment aims to provide an expanded view of an item.\n\nStep 1:\nPrepare your specimen. e.g(soil sample).\nStep 2:\nTake the specimen to the biology lab.\nStep 3:\n  The Microscope comes prebuit with the best adjustment, although you can adjust it.\nStep 4:\nInspect the specimen and make a sketch.\nStep 5:\nTake some notes.\nStep 6:\nTake the specimen away from the microscope." // You can add another practical or leave it empty.
                }
            ];
        ...
        return (
           ...
           !noteindex ? null :
            ...
            {indexNumber === 'Chemistry' ? (<Notebook text={notes[0].practical1} />) :
            indexNumber === 'Biology' ? (<Notebook text={notes[1].practical2} />) : null}
                       ...
                       <XR store={store}>
                        <Suspense fallback={<FallBack/>}>
                            ...
                            {!isOutside && mediaquery === 'desktop' ? (
                                ...
                                onClick={()=> checkNote()}
                            />) :
                                !isOutside && mediaquery === 'tablet' ? ( <Model modelPath='/misc/competition/models/exercise_book/book.glb'
                                    position={[-3, -3, 0]}
                                    scale={[0.3, 0.2, 0.7]}
                                    rotation={[1, 1, 1]}
                                    onClick={()=> checkNote()}
